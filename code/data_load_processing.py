...
def dataProcessing(path):
    """
    Read the data, and then encode the RNA molecular graph feature.
    """
...
def prepareData(PositiveCSV, NegativeCSV):
    ...
    :return           : RNA molecular graph features of positive and negative samples and their corresponding labels.
    """
